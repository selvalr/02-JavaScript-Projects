...
document.querySelector("#btn-access").onclick = () => {
  accessForm.classList.toggle("active");
};

document.querySelector("#close-btn-access").onclick = () => {
...
function loader() {
  document.querySelector(".charging-container").classList.add("active");
}
